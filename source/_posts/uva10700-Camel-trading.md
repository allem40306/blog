...
- 108 下
---
[題目連結](https://onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=1641)
* 題意：給定一串由 `+*` 組成的算式，載可以任意任何運算方式下，最小和最大的值為和。
<!-- more -->
* 題解：先用 `stringstream` 將運算元和運算子分離，再用遞迴算出每個區間的最大和最小值。
```cpp=
